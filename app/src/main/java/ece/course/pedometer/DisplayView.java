...
public class DisplayView extends SurfaceView {
    ...
    private float mRectHalfWidth =0.0f;
    private float mRectHalfHeight =0.0f;
    private float mRectStep =0.0f;
    ...
    private int mPtrColor = Color.GRAY;
    ...
    public void onDraw(Canvas canvas){
        ...
        canvas.drawRect(mCenterX-mRectHalfWidth, mCenterY-mRectHalfHeight, mCenterX+mRectHalfWidth, mCenterY+mRectHalfHeight, paint);
        paint.setColor(Color.YELLOW);
        canvas.drawRect(mCenterX-mRectHalfWidth, mCenterY-mRectHalfHeight+mRectStep, mCenterX+mRectHalfWidth, mCenterY+mRectHalfHeight-mRectStep, paint);
        paint.setColor(Color.BLUE);
        canvas.drawRect(mCenterX-mRectHalfWidth, mCenterY-mRectHalfHeight+2*mRectStep, mCenterX+mRectHalfWidth, mCenterY+mRectHalfHeight-2*mRectStep, paint);
        paint.setColor(Color.BLACK);
        canvas.drawRect(mCenterX-3*mRectHalfWidth, mCenterY-0.01f*mRectHalfHeight, mCenterX+3*mRectHalfWidth, mCenterY+0.01f*mRectHalfHeight, paint);
    ...
    public void onSizeChanged(int width, int height, int oldWidth, int oldHeight){
        mCenterX = width/2;
        mCenterY = height/2;
        mRadius = ((width < height)? width : height)*6.0f /8.0f;
        mRectHalfWidth = ((width < height)? width : height)*1.0f /12.0f;
        mRectHalfHeight = ((width > height)? width : height)*3.5f /8.0f;
        mRectStep = mRectHalfHeight/3;
